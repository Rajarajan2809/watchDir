...
public class consoleLog 
{
	public static boolean log(final String object) throws IOException
	{
		try
		{
			...
			File theDir = new File(System.getProperty ("user.home")+"/Library/Logs/Graphics_watcher/");//Users/comp/Library/Logs
	    	if (!theDir.exists()) 
			{
	    		theDir.mkdir();
			}
			Calendar cal = Calendar.getInstance();
	    	String fileName = theDir.getAbsolutePath()+"/Graphics_QS_"+new SimpleDateFormat("MMM").format(cal.getTime()) + new SimpleDateFormat("YY").format(cal.getTime())+".log";
